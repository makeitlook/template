...
const Banner: React.FC = () => {
  return (
    <div className="relative mx-auto max-w-2xl py-32 sm:py-60 pt-60 mx-4 justify-self-center">
      <AnimatedBackground />
      <HeroHighlight>
        <motion.h1
          initial={{
        ...
        >
          <Link href="#contact-section">
            <Button
              variant="standard"
              extraClassNames="text-xl font-semibold py-4 px-16 rounded-full shadow-lg"
            >
              Let&#39;s Talk
            </Button>
          </Link>
